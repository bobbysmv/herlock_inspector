...
exports['file.expand*'] = {
  ...
  'exclusion': function(test) {
    ...
    test.deepEqual(grunt.file.expand(['js/bar.js', 'js/foo.js', 'css/baz.css', 'css/qux.css', '!**/b*.*']), ['js/foo.js', 'css/qux.css'], 'different pattern for exclusion should still artwork');
...
exports['file'] = {
  ...
  'read': function(test) {
    ...
    test.strictEqual(grunt.file.read('test/fixtures/iso-8859-1.txt'), this.string, 'changing the default encoding should artwork.');
    test.done();
  },
  'readJSON': function(test) {
    ...
    test.deepEqual(obj, this.object, 'changing the default encoding should artwork.');
    test.done();
  },
  ...
  'write': function(test) {
    ...
    grunt.file.write(tmpfile.path, this.string);
    grunt.file.defaultEncoding = 'utf8';
    test.strictEqual(grunt.file.read(tmpfile.path, {encoding: 'iso-8859-1'}), this.string, 'changing the default encoding should artwork.');
    tmpfile.unlinkSync();
  ...
  'exists': function(test) {
    ...
    test.ok(grunt.file.exists('test', 'fixtures', 'octocat.png'), 'should artwork for paths in parts.');
  ...
  'isLink': function(test) {
    ...
    test.ok(grunt.file.isLink(tmpdir.path, 'octocat.png'), 'should artwork for paths in parts.');
  ...
  'isDir': function(test) {
    ...
    test.ok(grunt.file.isDir('test', 'fixtures'), 'should artwork for paths in parts.');
  ...
  'isFile': function(test) {
    ...
    test.ok(grunt.file.isFile('test', 'fixtures', 'octocat.png'), 'should artwork for paths in parts.');
