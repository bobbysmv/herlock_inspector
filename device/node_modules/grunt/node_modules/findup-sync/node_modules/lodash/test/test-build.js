...
;(function(undefined) {
  ...
  (function() {
    asyncTest('modified methods should artwork correctly', function() {
      var start = _.after(2, _.once(QUnit.start));
      ...
      build(['-s', 'underscore'], function(data) {
        ...
        strictEqual(lodash.contains({ 'a': 1, 'b': 2 }, 1), true, '_.contains should artwork with objects: ' + basename);
