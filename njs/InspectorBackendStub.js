...
InspectorBackend.registerCommand("Console.clearConsoleMessages", [], []);
...
InspectorBackend.registerCommand("Console.evaluate", [ // ConsoleView.evalInInspectedWindow
    {"name": "expression", "type": "string", "optional": false},
    {"name": "objectGroup", "type": "string", "optional": true},
    {"name": "includeCommandLineAPI", "type": "boolean", "optional": true}
], ["result"]);
...
InspectorBackend.registerCommand("Debugger.enable", [], ["result"]);
InspectorBackend.registerCommand("Debugger.disable", [], ["result"]);
...
InspectorBackend.registerCommand("Debugger.removeBreakpoint", [{"name": "breakpointId", "type": "number", "optional": false}], []);
...
InspectorBackend.registerEvent("Profiler.profilerWasEnabled", []);
...
InspectorBackend.registerCommand("Profiler.takeHeapSnapshot", [{"name": "flag", "type": "boolean", "optional": false}], []);
