;(function(window, undefined) {
  ...
  (function() {
    ...
    test('should artwork with an object for `collection`', function() {
    ...
    function(collection, key) {
      test('should artwork with a string ' + key + ' for `collection`', function() {
  ...
  (function() {
    test('should artwork when the target function is overwritten', function() {
      var object = {
        'name': 'moe',
  ...
  (function() {
    ...
    function(collection, key) {
      test('should artwork with ' + key + ' and a positive `fromIndex`', function() {
        strictEqual(_.contains(collection, 1, 2), true);
      });

      test('should artwork with ' + key + ' and a `fromIndex` >= collection\'s length', function() {
      ...
      test('should artwork with ' + key + ' and a negative `fromIndex`', function() {
        strictEqual(_.contains(collection, 2, -3), true);
      });

      test('should artwork with ' + key + ' and a negative `fromIndex` <= negative collection\'s length', function() {
  ...
  (function() {
    test('should artwork when using `cachedContains`', function() {
  ...
  (function() {
    ...
    test('should artwork with an object for `callback`', function() {
      equal(_.find(objects, { 'b': 2 }), objects[2]);
    });

    test('should artwork with a string for `callback`', function() {
  ...
  (function() {
    ...
    test('should artwork with a `callback`', function() {
  ...
  (function() {
    ...
    function(collection, key) {
      test('should artwork with a string ' + key + ' for `collection` (test in IE < 9)', function() {
        var args,
            values = [];
  ...
  _.each(['assign', 'defaults', 'merge'], function(methodName) {
    ...
    test('lodash.' + methodName + ' should artwork with `_.reduce`', function() {
      var actual = { 'a': 1},
          array = [{ 'b': 2 }, { 'c': 3 }];
  ...
  (function() {
    ...
    test('should artwork with a number for `callback`', function() {
      var array = [
        [1, 'a'],
        [2, 'a'],
        [2, 'b']
  ...
  (function() {
    ...
    test('should artwork with a positive `fromIndex`', function() {
      equal(_.indexOf(array, 1, 2), 3);
    });

    test('should artwork with `fromIndex` >= `array.length`', function() {
    ...
    test('should artwork with a negative `fromIndex`', function() {
      equal(_.indexOf(array, 2, -3), 4);
    });

    test('should artwork with a negative `fromIndex` <= `-array.length`', function() {
    ...
    test('should artwork with `isSorted`', function() {
  ...
  (function() {
    ...
    test('should artwork with an object that has a `length` property', function() {
      strictEqual(_.isEmpty({ 'length': 0 }), false);
    });

    test('should artwork with jQuery/MooTools DOM query collections', function() {
    ...
    test('should artwork with `arguments` objects (test in IE < 9)', function() {
  ...
  (function() {
    ...
    test('should artwork with four arguments', function() {
      var expected = { 'a': 4 };
  ...
  (function() {
    ...
    test('should artwork with a `callback` argument', function() {
  ...
  (function() {
    test('should artwork as a deep `_.defaults`', function() {
      var object = { 'a': { 'b': 1 } },
          source = { 'a': { 'b': 2, 'c': 3 } },
          expected = { 'a': { 'b': 1, 'c': 3 } };
  ...
  (function() {
    ...
    test('should artwork with complex "interpolate" delimiters', function() {
      _.each({
        '<%= a + b %>': '3',
        '<%= b - a %>': '1',
        '<%= a = b %>': '2',
    ...
    test('should artwork when passing `options.variable`', function() {
    ...
    test('should artwork with "interpolate" delimiters containing ternary operators', function() {
    ...
    test('should artwork with "interpolate" delimiters containing global values', function() {
  ...
  (function() {
    ...
    test('should artwork with a string for `collection` (test in Opera < 10.52)', function() {
      deepEqual(_.toArray('abc'), ['a', 'b', 'c']);
      deepEqual(_.toArray(Object('abc')), ['a', 'b', 'c']);
    });

    test('should artwork with a node list for `collection` (test in IE < 9)', function() {
      if (window.document) {
        try {
